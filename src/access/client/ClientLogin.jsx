...
function ClientLogin() {
    ...
    return (
        ...
        <div className="text-white w-full h-[100vh] bg-[#F4F4F4] flex flex-col justify-center items-center gap-3">
            ...
            <section className="w-[80%] h-[90vh] flex bg-[#1F8220] rounded-[4px] relative overflow-hidden shadow-2xl">
                ...
                <div className="w-[50%] h-[100%] flex flex-col justify-center items-center gap-6 relative">
                    ...
                    <button className="w-[300px] h-[41px] p-2 bg-white rounded-md text-[#1F8220]">entrar</button>
