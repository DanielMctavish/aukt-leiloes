...
function Footer() {
  ...
  return (
    <section className="w-full flex flex-col justify-center items-center border-t-[10px] border-[#1E1E1E] bg-[#012038] overflow-hidden relative p-3">
      <div className="flex md:flex-row flex-col w-full md:w-[90%] lg:w-[80%] bg-[#0D1733] rounded-[20px] shadow-2xl shadow-[#11111125]
            relative md:justify-center justify-start items-start gap-8 p-6 md:p-12 lg:p-16">
