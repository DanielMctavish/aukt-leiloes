      ...
      <div className=" flex lg:flex-row flex-col lg:w-[70%] w-[98%] h-full justify-between items-center overflow-hidden gap-1">
        ...
        justify-center items-center relative rounded-md gap-6 overflow-hidden">
          ...
          <div className="w-[90%] text-[#D7D7D7] text-[16px] text-justify z-20">
            Tem produtos para leilão? Nossa plataforma moderna e inovadora é o lugar perfeito para você! Selecionamos cautelosamente nossos anunciantes para garantir a melhor experiência de compra e venda. <br />
          ...
          <button className="bg-white flex w-[90%] p-2 text-[18px] rounded-md text-zinc-600 z-20">
            entrar em contato
          </button>
