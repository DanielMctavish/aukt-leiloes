    ...
    return (
        <div className="w-full h-screen bg-gradient-to-br from-[#f8f8f8] to-[#e8e8e8] flex">
            ...
            <section className="flex-1 h-screen flex flex-col gap-5 p-5 overflow-y-auto">
                ...
                <section className="bg-white/90 backdrop-blur-md rounded-xl shadow-md p-6 border border-gray-100">
                    <div className="flex flex-col md:flex-row gap-6 items-center md:items-start mb-6">
                        ...
                        <div className="text-center md:text-left">
                            ...
                            <p className="text-gray-500 text-sm">{currentClient.email}</p>
                        </div>
                    </div>

                    {/* Cards de Estatísticas */}
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="bg-gradient-to-br from-cyan-50 to-cyan-100 rounded-lg p-4 shadow-sm border border-cyan-200">
                            <div className="flex items-center gap-3 mb-2">
                                ...
                                <h3 className="text-sm font-medium text-gray-700">Total de Lances</h3>
                            </div>
                            <p className="text-2xl font-bold text-cyan-700">{allBids.length}</p>
                        </div>
                        ...
                        <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-4 shadow-sm border border-green-200">
                            <div className="flex items-center gap-3 mb-2">
                                ...
                                <h3 className="text-sm font-medium text-gray-700">Total de Arremates</h3>
                            </div>
                            <p className="text-2xl font-bold text-green-700">{bidsWinners.length}</p>
                        </div>
                        ...
                        <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-4 shadow-sm border border-blue-200">
                            <div className="flex items-center gap-3 mb-2">
                                ...
                                <h3 className="text-sm font-medium text-gray-700">Leilões Participados</h3>
                            </div>
                            <p className="text-2xl font-bold text-blue-700">{allAucts.length}</p>
                        </div>

                        <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-lg p-4 shadow-sm border border-indigo-200">
                            <div className="flex items-center gap-3 mb-2">
                                ...
                                <h3 className="text-sm font-medium text-gray-700">Total Investido</h3>
                            </div>
                ...
                <section className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                    {/* Arremates Recentes */}
                    <div className="bg-white/90 backdrop-blur-md rounded-xl shadow-md p-5 border border-gray-100">
                            ...
                            <table className="w-full">
                                <thead>
                                    <tr className="border-b border-gray-200">
                                        <th className="py-2 px-3 text-left text-xs font-medium text-gray-500">Leilão</th>
                                        <th className="py-2 px-3 text-left text-xs font-medium text-gray-500">Criador</th>
                                        <th className="py-2 px-3 text-left text-xs font-medium text-gray-500">Data</th>
                                    </tr>
                                </thead>
                                <tbody>
                                        ...
                                        <tr key={index} className="hover:bg-blue-50 transition-colors">
                                            <td className="py-2 px-3">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="text-xs text-gray-700 font-medium truncate">{auct.title}</span>
                                                </div>
                                            </td>
