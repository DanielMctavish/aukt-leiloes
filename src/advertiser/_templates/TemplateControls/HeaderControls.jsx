...
import { AspectRatio, Visibility, VisibilityOff, TextFields, FormatSize, BorderAll, Palette, Opacity } from '@mui/icons-material';
...
function HeaderControls({ template, updateHeader, selectedHeaderModel, setSelectedHeaderModel, selectedPalette }) {
    ...
    return (
        <div className="bg-white shadow rounded-lg p-4 mb-4">
            ...
            {/* Controles de posição e estilo dos textos */}
            <div className="mt-6 border-t pt-4">
                ...
                {template.header.texts?.map(text => (
                    ...
                    >
                        ...
                        {/* Controles que serão recolhidos */}
            ...
            {/* Controle de opacidade dos elementos */}
            <div className="mb-4">
                <label className="block text-sm font-medium text-gray-700 mb-2 flex items-center gap-2">
