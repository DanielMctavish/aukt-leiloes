...
function DisplayCreateEvent() {
    ...
    return (
        <div className="w-[30%] h-[100%] bg-white rounded-md p-2  shadow-2xl shadow-[#00000039] relative">
            ...
            <section className="w-full h-[30%] flex flex-col gap-2 justify-center items-center mt-6">
                <div className="w-[80%] flex flex-col gap-3">
                    ...
                    <div className="w-full h-[20vh] border-[1px] border-zinc-300 rounded-lg"></div>
                </div>
            </section>
