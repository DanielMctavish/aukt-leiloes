        ...
        <table className="w-full bg-white">
            <thead >
                <tr className="border-b-[.4px] border-zinc-300">
                    <th className="px-6 py-3 text-left text-zinc-400 font-semibold">Nº</th>
                    <th className="px-6 py-3 text-left text-zinc-400 font-semibold">ID - Leilão</th>
                    <th className="px-6 py-3 text-left text-zinc-400 font-semibold">Anunciante</th>
                    <th className="px-6 py-3 text-left text-zinc-400 font-semibold">Arremate</th>
                    <th className="px-6 py-3 text-left text-zinc-400 font-semibold">Título</th>
                    <th className="px-6 py-3 text-left text-zinc-400 font-semibold">Ficha</th>
                    <th className="px-6 py-3 text-left text-zinc-400 font-semibold">Venda</th>
                </tr>
            </thead>
            <tbody >
                <tr className="border-b-[.4px] border-zinc-300">
