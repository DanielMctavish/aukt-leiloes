        ...
        {DetailProduct.map((produto) => (
          <tr key={produto.id} className="border-b-[.4px] border-zinc-300  text-zinc-400">
            ...
            <td className="px-6 py-4 text-left space-x-3">
              <span className="bg-[#FA3A3A7D] px-5 text-[#AF0000] font-bold rounded-full p-2 text-[12px] cursor-pointer">{produto.excluir}</span>
              <span className="bg-[#3AFA4D7D] px-5 text-[#007004] font-bold rounded-full p-2 text-[12px] cursor-pointer">{produto.editar}</span>
