    ...
    >
      ...
      <section className="w-full h-[100vh] flex flex-col justify-start items-center">
        ...
        <section className="w-[90%] h-[20vh] flex justify-center items-center gap-6">
          ...
          <div className="w-[60%] h-[80%] bg-[#fff] rounded-md shadow-lg shadow-[#17171722] p-3 relative">
            <h2 className="bg-[#FA3A3A]/40 text-[#AF0000] p-1 rounded-full w-[80px] font-bold text-center">
              Live
            </h2>
          </div>
          <div className="w-[14%] h-[80%] bg-[#191F2F] text-[#FFFFFF] font-bold text-[12px] rounded-md shadow-lg shadow-[#17171722] p-3 relative flex justify-center items-center">
            <button>Transferir</button>
          </div>
        </section>

        <section className="w-[90%] h-auto flex justify-center items-center gap-6 ">
          <div className="w-[34%] h-[auto] bg-[#fff] rounded-md shadow-lg shadow-[#17171722] p-3">
          ...
          <div className="w-[70%] h-[auto] bg-[#fff] rounded-md shadow-lg shadow-[#17171722] p-2 relative ">
